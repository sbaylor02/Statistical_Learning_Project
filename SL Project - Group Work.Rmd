...
colnames(err_matrix) <- c("KNN","glm", "tree","other", 'other')

colnames(sensitivity_matrix)<- c("KNN","glm", "tree","other", 'other')

colnames(fmeasure_matrix) <- c("KNN","glm", "tree","other", 'other')

colnames(gmean_matrix) <- c("KNN","glm", "tree","other", 'other')
...
ggplot(err_graph, aes(x=X2, y=value))+geom_boxplot()
```
```{r}
sens_graph <- melt(sensitivity_matrix)

ggplot(sens_graph, aes(x=X2, y=value))+geom_boxplot()
```
```{r}
fmeas_graph <- melt(fmeasure_matrix)

ggplot(fmeas_graph, aes(x=X2, y=value))+geom_boxplot()
```

```{r}
gmean_graph <- melt(gmean_matrix)

ggplot(gmean_graph, aes(x=X2, y=value))+geom_boxplot()
```
