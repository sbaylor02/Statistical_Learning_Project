...
colnames(err_matrix) <- c("KNN","glm", "tree","RF", 'other')

colnames(sensitivity_matrix)<- c("KNN","glm", "tree","RF", 'other')

colnames(fmeasure_matrix) <- c("KNN","glm", "tree","RF", 'other')

colnames(gmean_matrix) <- c("KNN","glm", "tree","RF", 'other')
